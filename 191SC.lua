-- ELIXIR 3.5 + FULLY NV (FULL SCRIPT, SEMUA FITUR JALAN)
...
local cookAmount = 5
local buyRemote = ReplicatedStorage.RemoteEvents.StorePurchase
...
local function cookAtApartment()
    ...
    equip("Empty Bag"); spamE(10); task.wait(1.5)
...
local function sellAllMS()
    ...
    for _, bag in pairs(bags) do
        while fullyRunning and countItem(bag) > 0 do
            if equip(bag) then spamE(10); task.wait(0.8); sold = sold + 1; fullyTotalSold = fullyTotalSold + 1 else break end
        end
    end
    return true
end
...
local C = {
    ...
    border = Color3.fromRGB(38,32,62), blueD = Color3.fromRGB(48,88,200),
    blue = Color3.fromRGB(82,130,255), orange = Color3.fromRGB(255,160,40),
...
-- Pilih Apart
local apartCardF = card(fullyScroll, 80, 2)
local apartL = Instance.new("TextLabel", apartCardF)
...
local apartDropdown = Instance.new("TextButton", apartCardF)
...
-- Pilih Pot
local potCardF = card(fullyScroll, 80, 3)
local potL = Instance.new("TextLabel", potCardF)
...
local potKanan = Instance.new("TextButton", potCardF)
...
local potKiri = Instance.new("TextButton", potCardF)
...
-- Slider
local getTargetMS = stepperRow(fullyScroll, 230, "Target MS per Loop", 1, 50, 5, " MS")

-- Status
local statusCardNV = card(fullyScroll, 50, 4)
fullyStatusLabel = Instance.new("TextLabel", statusCardNV)
...
fullyStatusLabel.TextWrapped = true

-- Statistik
local statCardF = card(fullyScroll, 80, 5)
local cookedLabel = Instance.new("TextLabel", statCardF)
...
local cookedValue = Instance.new("TextLabel", statCardF)
...
cookedValue.TextColor3 = C.accentGlow

local soldLabel = Instance.new("TextLabel", statCardF)
...
local soldValue = Instance.new("TextLabel", statCardF)
...
soldValue.TextColor3 = C.accentGlow

local chemicalsLabel = Instance.new("TextLabel", fullyScroll)
chemicalsLabel.Size = UDim2.new(1, 0, 0, 22)
chemicalsLabel.Position = UDim2.new(0, 12, 0, 420)
chemicalsLabel.BackgroundTransparency = 1
chemicalsLabel.Text = "SISA BAHAN:"
chemicalsLabel.Font = Enum.Font.GothamBold
chemicalsLabel.TextSize = 10
chemicalsLabel.TextColor3 = C.textDim

local waterRowF = card(fullyScroll, 25, 6)
waterRowF.Position = UDim2.new(0, 12, 0, 445)
local waterLabelF = Instance.new("TextLabel", waterRowF)
waterLabelF.Size = UDim2.new(0.5, 0, 1, 0)
waterLabelF.Position = UDim2.new(0, 12, 0, 0)
waterLabelF.BackgroundTransparency = 1
waterLabelF.Text = "Water:"
waterLabelF.Font = Enum.Font.GothamSemibold
waterLabelF.TextSize = 11
waterLabelF.TextColor3 = C.textMid

local waterValueF = Instance.new("TextLabel", waterRowF)
waterValueF.Size = UDim2.new(0.4, 0, 1, 0)
waterValueF.Position = UDim2.new(0.6, 0, 0, 0)
waterValueF.BackgroundTransparency = 1
waterValueF.Text = "0"
waterValueF.Font = Enum.Font.GothamBold
waterValueF.TextSize = 12
waterValueF.TextColor3 = C.accentGlow

local sugarRowF = card(fullyScroll, 25, 7)
sugarRowF.Position = UDim2.new(0, 12, 0, 475)
local sugarLabelF = Instance.new("TextLabel", sugarRowF)
sugarLabelF.Size = UDim2.new(0.5, 0, 1, 0)
sugarLabelF.Position = UDim2.new(0, 12, 0, 0)
sugarLabelF.BackgroundTransparency = 1
sugarLabelF.Text = "Sugar Block Bag:"
sugarLabelF.Font = Enum.Font.GothamSemibold
sugarLabelF.TextSize = 11
sugarLabelF.TextColor3 = C.textMid

local sugarValueF = Instance.new("TextLabel", sugarRowF)
sugarValueF.Size = UDim2.new(0.4, 0, 1, 0)
sugarValueF.Position = UDim2.new(0.6, 0, 0, 0)
sugarValueF.BackgroundTransparency = 1
sugarValueF.Text = "0"
sugarValueF.Font = Enum.Font.GothamBold
sugarValueF.TextSize = 12
sugarValueF.TextColor3 = C.accentGlow

local gelatinRowF = card(fullyScroll, 25, 8)
gelatinRowF.Position = UDim2.new(0, 12, 0, 505)
local gelatinLabelF = Instance.new("TextLabel", gelatinRowF)
gelatinLabelF.Size = UDim2.new(0.5, 0, 1, 0)
gelatinLabelF.Position = UDim2.new(0, 12, 0, 0)
gelatinLabelF.BackgroundTransparency = 1
gelatinLabelF.Text = "Gelatin:"
gelatinLabelF.Font = Enum.Font.GothamSemibold
gelatinLabelF.TextSize = 11
gelatinLabelF.TextColor3 = C.textMid

local gelatinValueF = Instance.new("TextLabel", gelatinRowF)
gelatinValueF.Size = UDim2.new(0.4, 0, 1, 0)
gelatinValueF.Position = UDim2.new(0.6, 0, 0, 0)
gelatinValueF.BackgroundTransparency = 1
gelatinValueF.Text = "0"
gelatinValueF.Font = Enum.Font.GothamBold
gelatinValueF.TextSize = 12
gelatinValueF.TextColor3 = C.accentGlow

local emptyRowF = card(fullyScroll, 25, 9)
emptyRowF.Position = UDim2.new(0, 12, 0, 535)
local emptyLabelF = Instance.new("TextLabel", emptyRowF)
emptyLabelF.Size = UDim2.new(0.5, 0, 1, 0)
emptyLabelF.Position = UDim2.new(0, 12, 0, 0)
emptyLabelF.BackgroundTransparency = 1
emptyLabelF.Text = "Empty Bag:"
emptyLabelF.Font = Enum.Font.GothamSemibold
emptyLabelF.TextSize = 11
emptyLabelF.TextColor3 = C.textMid

local emptyValueF = Instance.new("TextLabel", emptyRowF)
emptyValueF.Size = UDim2.new(0.4, 0, 1, 0)
emptyValueF.Position = UDim2.new(0.6, 0, 0, 0)
emptyValueF.BackgroundTransparency = 1
emptyValueF.Text = "0"
emptyValueF.Font = Enum.Font.GothamBold
emptyValueF.TextSize = 12
emptyValueF.TextColor3 = C.accentGlow

-- Tombol Start/Stop
local btnFrameF = Instance.new("Frame", fullyScroll)
btnFrameF.Size = UDim2.new(1, 0, 0, 50)
btnFrameF.Position = UDim2.new(0, 0, 0, 570)
btnFrameF.BackgroundTransparency = 1

fullyStartBtn = makeActionBtn(btnFrameF, "▶ START FULLY NV", C.blueD, 0)
fullyStartBtn.Position = UDim2.new(0, 12, 0, 5)
fullyStartBtn.Size = UDim2.new(1, -24, 0, 36)

fullyStopBtn = makeActionBtn(btnFrameF, "■ STOP FULLY NV", C.red, 0)
fullyStopBtn.Position = UDim2.new(0, 12, 0, 5)
fullyStopBtn.Size = UDim2.new(1, -24, 0, 36)
...
task.spawn(function()
    while true do
        task.wait(0.5)
        pcall(function()
            cookedValue.Text = tostring(fullyTotalCooked)
            soldValue.Text = tostring(fullyTotalSold)
            waterValueF.Text = tostring(countItem("Water"))
            sugarValueF.Text = tostring(countItem("Sugar Block Bag"))
            gelatinValueF.Text = tostring(countItem("Gelatin"))
            emptyValueF.Text = tostring(countItem("Empty Bag"))
        end)
    end
end)
