...
local fpage = pages["FULLY NV"]
for _, v in pairs(fpage:GetChildren()) do if v:IsA("Frame") or v:IsA("TextLabel") or v:IsA("TextButton") then v:Destroy() end end
...
local scr = Instance.new("ScrollingFrame", fpage)
