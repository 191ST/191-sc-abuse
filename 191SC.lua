...
-- ==================== KEY SYSTEM ====================
local keyCorrect = "191STORE"

-- Membuat ScreenGui untuk Key System
...
titleText.Text = "🔐 191 STORE - KEY SYSTEM"
...
instructionLabel.Position = UDim2.new(0, 0, 0, 5)
instructionLabel.BackgroundTransparency = 1
instructionLabel.Text = "MASUKKAN KEY UNTUK AKSES HUB:"
...
local function checkKey()
	...
	if inputKey == keyCorrect then
		-- Key benar
		statusLabel.Text = "✓ KEY BENAR! LOADING HUB..."
